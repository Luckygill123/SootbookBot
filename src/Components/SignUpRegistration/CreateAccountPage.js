            ...
            <div className='creatAccountForm_wrapper'>
             <div className='form_container'>
                    ...
                    <div className='input_flexBox'>
                        ...
                        <input type='text' className='text_input' onChange={handleFullName} value={fullName}></input>
                    </div>
                    <div className='input_flexBox'>
                        <label>{locales.email_label}</label>
                        <input type='text' className='text_input' onChange={handleEmailChange} value={email}></input>
                    ...
                    <div className='input_flexBox password_box'>
                        ...
                        <input ref={inputRef} className='text_input' type="password" value={password} onChange={handlePassword}></input>
                    ...
                    <div className='input_flexBox phonenumber_box'>
                        ...
                        >
                            {
                                ...
                                countryData.map((item, index) => {      
                                    return (
                                        <MenuItem key={index} name={item.name} value={item._id}>{item.phone}</MenuItem>
                                    )
                        ...
                        <input type='text' maxLength={maxlengthPhone} className='phone_input' value={phone} onChange={handlePhone}></input>
                        </div>
                        
                    </div>
                    <div className='submit_action'>
                        <button className={`continue_btn ${(isValid == true
                             && phoneisValid == true 
                             && fullName!=='' 
                             && email!==""
                             && phone!==""
                             && password !==""
                             && countryselectedData!=="") ? '' : 'disabled' } `} onClick={handleSubmit}>{locales.continue_to_verification}</button>
                    </div>
