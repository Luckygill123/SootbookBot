            ...
            <div className='jobSingle_page_container'>
                        ...
                        <div className='jobcontent_flexbox'>
                            ...
                            <div className='job_details'>
                                ...
                                <div className='body'>
                                    ...
                                    <button className='apply_job_Btn'>
                                        Apply for job
                                    </button>
                                </div>
                            </div>
                            ...
                            <form>
                                <div className='input_flexbox'>
                                    <div className='input_box'>
                                        ...
                                        <input type='text' className='input_element' placeholder='Input'></input>
                                    </div>
                                    <div className='input_box'>
                                        <label>Email</label>
                                        <input type='text' className='input_element' placeholder='you@example.com'></input>
                                    </div>
                                </div>
                                <div className='input_flexbox'>
                                    <div className='input_box'>
                                        ...
                                        <div className='country_selectBox'>
                                            ...
                                            >
                                                <MenuItem value={"US"}><img src={Usflag} alt="flag" className='flag_icon'></img> US</MenuItem>
                                                <MenuItem value={"IND"}>IND</MenuItem>
                                                <MenuItem value={"ENG"}>ENG</MenuItem>
                                            </Select>
                                            <input type='text' className='country_input_element' placeholder='+1 (000) 000-0000'></input>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div className='drag_drop'>
                                        <div className='content'>
                                            <span className='upload_icon'>
                                                <img src={UploadImage} alt="upload_icon" className='upload_img'></img>
                                            </span>
                                            <div className='section-title'>Drop your files here or<span className='highlight'>browse</span></div>
                                ...
                                <div className='motivation_letterBox'>
                                    ...
                                    <textarea placeholder='you@email.com' className='textarea_box'></textarea>
                                </div>
                                <div className='agree_termcheckBox_container'>
                                    <FormControlLabel className='agree_term' control={<Checkbox />} label="I agree that my submitted data is being collected and stored." />
                                </div>
                ...
                <div className='jobs_interest_section'>
                    <div className='container'>
                        ...
                        <p className='description'>"Our philosophy is clear and direct: we believe in building a team of diverse, passionate individuals and nurturing a culture that empowers everyone to do their best work."</p>
