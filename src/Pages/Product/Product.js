                    ...
                    <div className='container'>
                        <div className='flexbox'>
                            <div className='content'>
                                ...
                                <p className='description'>With FOGO's Ecommerce solution, you can increase your reach, tap into 24/7 sales potential, and provide an enhanced customer experience. Take your pharmacy business to the next level with our cutting-edge technology.</p>
                    ...
                    <div className='container'>
                        ...
                        <div className='thumbnail'>
                            ...
                            <div className='content'>
                                ...
                                <p className='description'>Setting up your online store has never been easier. FOGO provides all the tools and support you need to establish a successful digital storefront.</p>
                                <div className='efficiency_flexbox'>
                                    <div className='flex_item'>
                                        {/* <span className='icon_block'>
                                            <img src={RelumeBlack} alt="icon"></img>
                                    ...
                                    <div className='flex_item'>
                                        ...
                                        <p className='card_info'>Integrate your online store with FOGO's ERP software for seamless inventory management and order processing.</p>
                                    </div>
                                </div>
                                <div className='actions'>
                        <button className='sign_up_btn'>{locales.signUp}</button>
                ...
                <div className='preferred_payment'>
                    <div className='container'>
                        ...
                        <div className='content'>
                                ...
                                <p className='description'>Our Ecommerce solution offers a range of secure payment gateway options to ensure smooth and hassle-free transactions. Whether you prefer PayPal, Stripe, or another trusted provider, we've got you covered.</p>
                             <ul className='prefer_points'>
                                <li>
                                    ...
                                    <span className='text'>
                                    PayPal: The trusted choice for online payments.
                                    </span>
                                </li>
                                <li>
                                    <span className='icon'>
                                    ...
                                    <span className='text'>
                                    Stripe: Securely accept credit card payments on your website.
                                    </span>
                                </li>
                                <li>
                                    <span className='icon'>
                                    ...
                                    <span className='text'>
                                    Authorize.Net: Simplify your payment processing with Authorize.Net.
                                    </span>
                                </li>
                             </ul>
                                <div className='actions'>
                    ...
                    <div className='container'>
                        <div className='flexbox'>
                            ...
                            <div className='content'>
                                ...
                                <p className='description'>Experience the seamless integration of our Ecommerce platform with your pharmacy's existing inventory management system. Streamline your operations and boost your online sales with ease.</p>
                                <div className='efficiency_flexbox'>
                                    <div className='flex_item'>
                                        {/* <span className='icon_block'>
                                            <img src={RelumeBlack} alt="icon"></img>
                                        ...
                                        <p className='card_info'>Sync your inventory in real-time, manage orders, and track sales all in one place.</p>
                                    </div>
                                    <div className='flex_item'>
                                        {/* <span className='icon_block'>
                                            <img src={RelumeBlack} alt="icon"></img>
                                        ...
                                        <p className='card_info'>Expand your customer reach and boost revenue with our integrated Ecommerce solution.</p>
                                    </div>
                                </div>
                                <div className='actions'>
                        <button className='sign_up_btn'>{locales.signUp}</button>
                ...
                <div className='shopping_experience'>
                    <div className='container'>
                        ...
                        <div className='content'>
                                ...
                                <p className='description'>Our user-friendly shopping cart and checkout features are designed to provide a seamless and convenient experience for customers. With easy navigation and intuitive design, you can quickly find and purchase the products you need.</p>
                                <div className='efficiency_flexbox'>
                                    <div className='flex_item'>
                                        <span className='icon_block'>
                                            <img src={RelumeBlack} alt="icon"></img>
                                        ...
                                        <p className='card_info'>Effortlessly add items to your cart and complete your purchase in just a few clicks.</p>
                                    </div>
                                    <div className='flex_item'>
                                        <span className='icon_block'>
                                            <img src={RelumeBlack} alt="icon"></img>
                                        ...
                                        <p className='card_info'>Rest assured that your personal and payment information is protected with advanced security measures.</p>
                                    </div>
                                </div>
                                <div className='actions'>
                        <button className='sign_up_btn'>{locales.signUp}</button>
                    ...
                    <div className='container'>
                        ...
                        <div className='grid_box'>
                            ...
                            <div className='card'>
                                ...
                                <span className='info'>Our ERP system simplifies the order processing for pharmacies. It automates the order entry, tracks inventory availability, and generates packing slips for efficient order fulfillment.</span>
                                <Link className='learn_moreLink'>
                                    Learn more
                                    <span className='icon'><RightArrow /></span>
                                </Link>
